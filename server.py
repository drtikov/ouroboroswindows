...
if __name__ == "__main__":
    ...
    # Do not use uvloop on Windows
    loop_setup = "asyncio" if sys.platform == "win32" else "auto"
    config = uvicorn.Config(app, host="127.0.0.1", port=actual_port, log_level="warning", loop=loop_setup)
